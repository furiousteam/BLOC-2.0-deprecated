...
void viewWalletMsg()
{
    std::cout << InformationMsg("Please remember that when using a view wallet "
              ...
              << std::endl << "This means if you received 100 BLOC and then "
              << "sent 50 BLOC, your balance would appear to still be 100 "
              << "BLOC." << std::endl
...
void connectingMsg()
{
    std::cout << std::endl << "Making initial contact with BLOCd."
              << std::endl
...
void promptSaveKeys(CryptoNote::WalletGreen &wallet)
{
    std::cout << "Welcome to your new wallet, here is your payment address:"
              ...
              << std::endl << std::endl 
              << "Please copy your secret keys and store "
