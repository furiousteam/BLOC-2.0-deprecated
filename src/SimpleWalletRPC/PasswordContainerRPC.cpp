...
namespace Tools
{
  ...
  PasswordContainerRPC::PasswordContainerRPC()
    : m_empty(true)
  {
  }

  PasswordContainerRPC::PasswordContainerRPC(std::string&& password)
    : m_empty(false)
    , m_password(std::move(password))
  {
  }

  PasswordContainerRPC::PasswordContainerRPC(PasswordContainerRPC&& rhs)
  ...
  void PasswordContainerRPC::clear()
  {
  ...
  bool PasswordContainerRPC::read_password()
  {
    clear();
  ...
  bool PasswordContainerRPC::read_from_file()
  {
  ...
  bool PasswordContainerRPC::read_from_tty()
  {
