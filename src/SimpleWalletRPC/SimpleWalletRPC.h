...
#include "PasswordContainerRPC.h"
...
namespace CryptoNote
{
  ...
  /*                                                                      */
  /************************************************************************/
  class Simple_WalletRPC : public CryptoNote::INodeObserver, public CryptoNote::IWalletLegacyObserver, public CryptoNote::INodeRpcProxyObserver {
  public:
    Simple_WalletRPC(System::Dispatcher& dispatcher, const CryptoNote::Currency& currency, Logging::LoggerManager& log);
  ...
  private:
    ...
    {
    public:
      refresh_progress_reporter_t(CryptoNote::Simple_WalletRPC& Simple_WalletRPC)
        : m_simple_wallet(Simple_WalletRPC)
    ...
    private:
      CryptoNote::Simple_WalletRPC& m_simple_wallet;
